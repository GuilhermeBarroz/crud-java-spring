...
import com.agenda.agenda.database.RepositorioContato;
...
public class ContatoRest {
    ...
    @Autowired //O spring cria o objeto e gerencia seu ciclo de vida.

    private RepositorioContato repositorio;

    //METODO QUE BUSCA TODOS OS CONTATOS NO BD
    @GetMapping
